...
function selectArea() {
    return new Promise((resolve) => {
        ...
        overlay.innerHTML = '<div style="color:white;text-align:center;margin-top:20px;font-size:20px">Click and drag to select the puzzle board</div>';
...
async function solvePuzzle() {
    ...
    const board = await parseQueensBoard(imageData, 7, area);
